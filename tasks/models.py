...
class User(AbstractUser):
    ...
    # Using full_name instead of username, first_name, last_name
    ...
    # Remove username field by setting it to None in the model
    username = None
    ...
    def save(self, *args, **kwargs):
        # Ensure the email is normalized and properly set
        if self.email:
            self.email = self.__class__.objects.normalize_email(self.email)
        # Call the parent save method to handle all other fields normally
